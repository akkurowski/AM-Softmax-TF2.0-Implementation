...
lda     = LinearDiscriminantAnalysis(n_components=3) # LDA jest podobna do PCA, ale uwzględnia informację o tym, który punkt należy do której klasy. Dzięki temu może obliczyć takie rzutowanie z przestrzeni wysokowymiarowej na niskowymiarową, że uzyskana jest maksymalna separacja pomiędzy klasami, przydatna do zgrubnego określenia wizualnie jak dobrze udało nam się rozseparować klasy
